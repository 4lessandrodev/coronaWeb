...
const salvarConsultas = (req, res, next) => {
  const consulta = new Consulta(req.body.teve_febre, req.body.tomou_medicamento, req.body.melhorou_apos_medicamento, req.body.contato_alguem_corona, req.body.viagem_internacional, req.body.outros_sintomas, req.body.gravidez, req.body.id_usuario);
...
module.exports = { cadastrarUsuario, salvarConsultas, listarConsultas, verConsulta };