...
let febre = false, dRespiratoria = false, contatoCovid = false, tosse = false, cansaco = false;
...
let resultado = () => {
  if ((dRespiratoria && contatoCovid) || contatoCovid) {
    ...
    RESULTADO.textContent = `Seus sintomas não são suficiente para ser uma possível suspeita de CONVID-19, continue acompanhando, se você não se sentir melhor em pouco tempo entre em contato
